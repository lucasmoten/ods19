...
type ODObjectType struct {
	...
	/*
		...
		type and has implict full permissions on it
	*/
	...
	*/
	...
	/*
		Properties is an array of Object Properties associated with this Object Type
		structured as key/value with portion marking.  When new objects are created
		of this type, the properties defined on the type act as default initializer
	*/
