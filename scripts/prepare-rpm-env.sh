...
install -m 640 -D ${ODRIVE_ROOT}/server/static/object-drive-1.0-sag.pdf ${ODRIVE_PACKAGE_NAME}/opt/services/object-drive-1.0/libs/server/static/object-drive-1.0-sag.pdf
