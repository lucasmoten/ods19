...
func TestRemoveObjectShare(t *testing.T) {
	...
	shareuri := host + "/service/metadataconnector/1.0/object/" + folder1.ID + "/share"
	...
	removeshareuri := host + "/service/metadataconnector/1.0/object/" + folder1.ID + "/share/" + createdShare.ID
