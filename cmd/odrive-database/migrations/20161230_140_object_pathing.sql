...
-- ensure triggers on object for create/update are without pathing calls
...
BEGIN
    ...
    OVERALL: BEGIN
        ...
        DECLARE cursor_objects cursor for SELECT id, parentid, createdBy, ownedby, name, rawacm FROM object WHERE name like concat('%', vPathDelimiter, '%');
        ...
        get_object: LOOP
            ...
            SELECT locate(vPathDelimiter, vName) INTO posPart;
            WHILE posPart > 0 DO
                OBJ_DELIM: BEGIN
