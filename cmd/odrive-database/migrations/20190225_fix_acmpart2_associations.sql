...
-- Analyzes ACM2 to determine if missing corresponding ACMPART2 rows and perform repairs
-- Clears the User AO Cache and ACM associations to force a rebuild on next login
...
DELETE FROM useracm;
INSERT INTO migration_status SET description = '20190225_fix_acmpart2_associations setting schemaversion to 20190225';
update dbstate set schemaVersion = '20190225' where schemaVersion <> '20190225';
