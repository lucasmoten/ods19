...
func getRootObjectsInTransaction(dao *DataAccessLayer, tx *sqlx.Tx, pagingRequest PagingRequest, loadPermissions bool, loadProperties bool) (models.ODObjectResultset, error) {
