...
func updateObjectInTransaction(logger zap.Logger, tx *sqlx.Tx, object *models.ODObject) (bool, error) {
	...
	if acmCreated, err = setObjectACM2ForObjectInTransaction(tx, object); err != nil {
