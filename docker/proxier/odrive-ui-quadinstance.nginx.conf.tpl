upstream odrivecluster {
    server ${ODRIVE1_SERVICE_HOST}:${ODRIVE1_SERVICE_PORT};
    server ${ODRIVE2_SERVICE_HOST}:${ODRIVE2_SERVICE_PORT};
    server ${ODRIVE3_SERVICE_HOST}:${ODRIVE3_SERVICE_PORT};
    server ${ODRIVE4_SERVICE_HOST}:${ODRIVE4_SERVICE_PORT};
}
...
ES128-GCM-SHA256:AES256-SHA256:AES128-SHA256:AES256-SHA:AES128-SHA:DES-CBC3-SHA:HIGH:!aNULL:!eNULL:!EXPORT:!CAMELLIA:!DES:!MD5:!PSK:!RC4';
    ...
    location ^~ /services/object-drive/${ODRIVE_VERSION}/ {
        rewrite ^/services/object-drive/${ODRIVE_VERSION}/(.*) /$1; 
        ...
        proxy_pass https://odrivecluster;
        break;
    }
